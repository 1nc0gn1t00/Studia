...
def compile_shaders():
    vertex_shader_source = """
        ...
        layout(location = 1) in vec3 color; // Nowy atrybut wejściowy (Zadanie 2)

        out vec4 vertex_color; // Przekazanie do fragment shadera
        ...
        void main(void) {
            ...
            vertex_color = vec4(color, 1.0); // Przepisanie koloru z bufora
        }
    """
    ...
    fragment_shader_source = """
        ...
        in vec4 vertex_color; // Odbiór koloru z vertex shadera
        out vec4 color;
