...
# Zmienne do obracania obiektem (jajkiem)
theta = 0.0
phi = 0.0
pix2angle = 1.0
...
light_diffuse = [0.8, 0.8, 0.0, 1.0]  # Żółte światło
light_specular = [1.0, 1.0, 1.0, 1.0]
light_position = [0.0, 0.0, 10.0, 1.0]  # Światło z przodu, nieruchome
...
def calculate_egg_data():
    """Oblicza wierzchołki i wektory normalne (surowe)"""
    ...
    for i in range(N):
        ...
        for j in range(N):
            ...
            # Wektory normalne (Pochodne cząstkowe)
            ...
            # Przypisanie wektora bez poprawki zwrotu (Zadanie 4)
...
def startup():
    ...
    glLightfv(GL_LIGHT0, GL_POSITION, light_position)  # Pozycja ustalona raz
...
def render(time):
    ...
    # Obsługa obracania jajkiem
    if left_mouse_button_pressed:
        theta += delta_x * pix2angle
        phi += delta_y * pix2angle

    # Obracamy układ współrzędnych (czyli jajko)
